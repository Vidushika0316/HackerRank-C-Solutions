...
The first line contains a single integer n, denoting the number of boxes.
 lines follow with three integers on each separated by single spaces length[i] ,width[i]  and heigth[i]  which are length, width and height in feet of the -th box.
